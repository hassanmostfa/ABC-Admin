        ...
        <SimpleBar className="h-n80">
          <div className="p-4">
            ...
            <div className="flex gap-4 mb-7">
              <Button
                color={"primary"}
                className={`border bg-transparent text-darklink btn-shadow border-ld  dark:text-white  hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7 dark:hover:text-white 
                ${
                  activeMode === "light"
              ...
              <Button
                color={"primary"}
                className={`border bg-transparent dark:text-white border-ld text-darklink hover:bg-primary  dark:hover:text-white hover:text-white rounded-md py-3 h-15 px-7 ${
                  activeMode === "dark"
            ...
            <div className="flex gap-4 mb-7">
              <Button
                color={"primary"}
                className={`border bg-transparent text-darklink dark:text-white border-ld  hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7  dark:hover:text-white ${
                  activeDir === "ltr"
              ...
              <Button
                color={"primary"}
                className={`border bg-transparent btn-shadow border-ld text-darklink dark:text-white hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7 ${
                  activeDir === "rtl"
                    ? "text-primary bg-lightprimary  dark:text-white dark:bg-darkminisidebar hover:bg-lightprimary hover:text-primary dark:hover:!bg-lightprimary"
                    : "dark:hover:bg-darkminisidebar hover:bg-lightprimary hover:text-primary dark:hover:!bg-lightprimary"
                }`}
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              <Button
                color={"primary"}
                className={`border bg-transparent btn-shadow border-ld text-darklink dark:text-white hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7  dark:hover:text-white ${
              ...
              <Button
                ...
                className={`border bg-transparent dark:text-white border-ld text-darklink hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7 ${
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              ...
              <Button
                color={"primary"}
                className={`border bg-transparent dark:text-white border-ld text-darklink hover:bg-primary hover:text-white rounded-md py-3 h-15 px-7 dark:hover:text-white ${
                  isCardShadow
                    ? "text-primary bg-lightprimary  dark:text-white dark:bg-darkminisidebar hover:bg-lightprimary hover:text-primary dark:hover:!bg-lightprimary"
                    : "dark:hover:bg-darkminisidebar hover:bg-lightprimary hover:text-primary dark:hover:!bg-lightprimary"
                }`}

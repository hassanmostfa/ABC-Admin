    ...
    <>
      <div className="dark:bg-dark">
        <div className="max-w-[800px] mx-auto px-5 lg:py-24 py-12">
          ...
          <Accordion className="shadow-none dark:shadow-none divide-y-0 divide-b-0 divided:border-transparent !rounded-none flex flex-col gap-4">
            {Questions.map((item,index) => {
              return (
               
                  <AccordionPanel key={index}>
                    <AccordionTitle className="focus:ring-0 px-6  text-lg text-ld py-5 border border-ld rounded-md !border-b-none">
                      {item.question}
                    </AccordionTitle>
                    <AccordionContent className="p-0! px-0 pt-0 rounded-none">

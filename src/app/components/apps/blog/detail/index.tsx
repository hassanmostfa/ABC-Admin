            ...
            <div className="px-6 pb-6">
              ...
              <div>
                <div className="flex gap-3">
                  <div className="flex gap-2 items-center text-darklink dark:text-bodytext text-15">
                  ...
                  <div className="ms-auto flex gap-2 items-center  text-darklink dark:text-bodytext text-15">
                    <GoDot 
                      size="16"
                      className="text-ld"
                    />

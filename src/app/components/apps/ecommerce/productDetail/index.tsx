            ...
            <form className="max-w-xs">
              <div className="relative flex items-center ">
                ...
                <button
                  ...
                  className="focus:ring-0 focus:outline-hidden border border-ld h-10 min-w-10 rounded-e-md rounded-s-none text-center flex justify-center items-center hover:bg-lightprimary hover:bg-lightprimary hover:text-primary"
                >

...
import { TextInput, Modal, Label, Button, Select, ModalHeader, ModalBody, ModalFooter } from "flowbite-react";
...
function EditTaskModal({ show, onHide, editedTask, onSave }: any) {
  ...
  return (
    <Modal size={"md"} show={show} onClose={onHide}>
      <ModalHeader className="pb-0 border-transparent">Edit Task</ModalHeader>
      <ModalBody>

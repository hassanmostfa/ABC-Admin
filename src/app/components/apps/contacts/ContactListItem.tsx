...
const ContactListItem: React.FC<ContactListItemProps> = ({
  ...
  const handleDeleteClick = () => {
    if (selectedContact) {
      ...
      setDeleteContactId(selectedContact.id)
      setOpenModal(true);
    }
  };
  ...
  return (
    <>
      <Drawer
        ...
        className="lg:relative lg:translate-none lg:h-auto lg:bg-transparent w-full lg:z-0"
      >
        <div className="lg:hidden block p-6 pb-2">
          <Button
            ...
            className="py-0"
          >
            <Icon icon="solar:round-arrow-left-linear" className="me-2" height={18}></Icon>Back
          </Button>
        </div>

    ...
    <>
      <div className="grid grid-cols-12 gap-6">
        <div className="lg:col-span-3 md:col-span-6  col-span-12">
          <div
            className="p-30 bg-lightprimary dark:bg-lightprimary text-center rounded-md cursor-pointer"
        ...
        <div className="lg:col-span-3 md:col-span-6  col-span-12">
          <div
            className="p-30 bg-lightwarning dark:bg-lightwarning text-center rounded-md cursor-pointer"
        ...
        <div className="lg:col-span-3 md:col-span-6  col-span-12">
          <div
            className="p-30 bg-lightsuccess dark:bg-lightsuccess text-center rounded-md cursor-pointer"
        ...
        <div className="lg:col-span-3 md:col-span-6  col-span-12">
          <div
            className="p-30 bg-lighterror dark:bg-lighterror text-center rounded-md cursor-pointer"

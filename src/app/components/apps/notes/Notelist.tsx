                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div>
                      <Tooltip content="Delete">
                        <Button
                          aria-label="delete"
                          className="bg-transparent dark:bg-transparent hover:bg-transparent h-8 w-8 text-ld p-0 flex items-center dark:hover:bg-transparent hover:text-dark dark:hover:text-white"

      ...
      <CardBox>
        ...
        <form className="flex max-w-md flex-col gap-4">
          ...
          <div>
            ...
            <TextInput className="form-control" id="password2" type="password" required shadow />
          </div>
          <div>
            <div className="mb-2 block">
              <Label htmlFor="repeat-password">Repeat password</Label>
            </div>
            <TextInput className="form-control" id="repeat-password" type="password" required shadow />
          </div>

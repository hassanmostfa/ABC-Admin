...
header: ({ table }) => {
  ...
  return (
    <Checkbox
      ...
      className="h-[18px] w-[18px] border border-border dark:border-darkborder bg-white dark:bg-transparent !data-[checked]:bg-primary dark:data-checked:bg-primary rounded cursor-pointer focus:ring-0 focus:ring-offset-0 outline-hidden"
    />
  );
}
,

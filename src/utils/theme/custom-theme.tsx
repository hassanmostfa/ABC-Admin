...
const customTheme = createTheme({
  ...
  card: {
    root: {
      base: "flex rounded-tw  shadow-md dark:shadow-none bg-white dark:bg-darkgray p-30 relative w-full break-words",
  ...
  dropdown: {
    ...
    content: "focus:outline-hidden !bg-transparent",
    floating: {
      ...
      base: "z-10 w-fit  items-center focus:outline-hidden  shadow-md dark:shadow-dark-md text-start rounded-sm overflow-hidden",
      content: "py-2 text-sm text-bodytext focus:outline-hidden",
  ...
  progress: {
    ...
    checkbox: {
  "base": "h-[18px] w-[18px] appearance-none rounded border border-gray-300 bg-transparent dark:bg-transparent bg-[length:0.55em_0.55em] bg-center bg-no-repeat checked:border-transparent checked:bg-current checked:bg-check-icon focus:outline-none focus:ring-offset-0 dark:border-gray-600 dark:bg-gray-700 dark:checked:border-transparent dark:checked:bg-current focus:ring-0 cursor-pointer",
  "color": {
    "default": "text-primary focus:ring-primary dark:focus:ring-primary",
  ...
  alert: {
    ...
    color: {
      ...
      warning: "bg-warning text-white border-yellow-500 dark:text-yellow-800",
  ...
  "item": {
    "base": "absolute left-0 top-0 !static block w-full -translate-x-0 -translate-y-0",
    "wrapper": {
  ...
  hr: {
    ...
    text: {
      ...
      text: "absolute left-1/2 -translate-x-1/2 bg-white px-3 md:text-15 text-13 font-normal text-bodytext dark:bg-darkgray dark:text-white",
    },
  },
    ...
    popup: {
      ...
      header: {
        ...
        selectors: {
          ...
          button: {
            base: "rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-gray-900 hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600",
            prev: "",
            next: "",
            view: "",
          },
  ...
  popover: {
    base: "absolute z-20 inline-block w-max max-w-screen bg-white rounded-lg outline-hidden shadow-sm dark:border-gray-600 dark:bg-gray-800",
  ...
  sidebar: {
    ...
    collapse: {
      ...
      label: {
        base: "flex justify-start flex-1 max-w-36 overflow-hidden truncate m-0 text-[15px]",
      },
    },
    itemGroup: {
